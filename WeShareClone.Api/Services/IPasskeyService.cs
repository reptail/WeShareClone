...
namespace WeShareClone.Api.Services;
...
public interface IPasskeyService
{
    ...
    /// <summary>Validates and stores a new passkey credential. Requires an authenticated user.</summary>
    Task CompleteRegistrationAsync(int userId, string email, AuthenticatorAttestationRawResponse attestationResponse);

    /// <summary>Generates assertion options for a passkey login. Returns null if the user has no registered passkeys.</summary>
